    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="bg-white z-50 text-black rounded-lg shadow-xl">
            <DialogHeader  className="text-center">
                ...
                <DialogDescription className="text-center mt-5 text-gray-500">
                    Ask a question and chat to the document with AI.
                </DialogDescription>

                <hr className="mt-5" />

                {question && <p className="text-center mt-5 text-gray-500">Q: {question}</p>}
            </DialogHeader> 
            ...
            {summary && (
                ...
                overflow-y-scroll gap-2 p-5 bg-gray-100">
                    ...
                    <p> {isPending ? "Thinking..." : <Markdown>{summary}</
                    Markdown>}</p>
                </div>
            )}
            ...
            <form className = "flex gap-2" onSubmit = {handleAskQuestion}>
                ...
                />
                <Button className="bg-black z-50 text-white rounded-lg shadow-xl" type="submit" disabled={!input || isPending}>
